  ...
  return (prop: JSX.IntrinsicAttributes) => {
    return inErrorState ? (
      <div
        ...
        className="p-4 mb-4 text-sm cursor-pointer text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
        role="alert"
      >
        <span className="font-medium">Danger alert!</span> Error Accrued. Press the reset button to
        try again.
      </div>
    ) : (
      <Component {...prop} />
