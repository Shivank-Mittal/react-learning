...
export default function PasswordGenerator() {
    ...
    function ShowToaster() {
        ...
        return (  
        <div id="toast-simple" className="absolute top-10 left-10 flex items-center w-full max-w-xs p-4 space-x-4 rtl:space-x-reverse text-gray-500 bg-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow-sm dark:text-gray-400 dark:divide-gray-700 dark:bg-gray-800" role="alert">
            ...
            <div className="max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className='flex gap-5 justify-around pt-5'>
                    ...
                    <div className="flex items-center">
                        <input id="checked-checkbox" checked= {includeNumber} onClick={() => setUseNumber(prevNumber => !prevNumber )} type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <label className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Numbers</label>
                    </div>
                    <div className="flex items-center">
                        <input id="checked-checkbox" checked= {includeCharacters} onClick={() => setCharacters(prevChar => !prevChar )} type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
