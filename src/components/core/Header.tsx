            ...
            {(() => {
              ...
              for (const [key, value] of menus.entries()) {
                list.push(
                  <li
                    key={key}
                    className='className="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page"'
                  >
                    <NavLink
                      to={key}
                      className={(state) =>
